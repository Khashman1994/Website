...
const PLANS = [
  ...
  },
  {
    ...
    titleEN:  'Value Pack',
    titleAR:  'باقة القيمة',
    descEN:   '75 Stars — best value per star',
    descAR:   '75 نجمة — أفضل قيمة للنجمة',
    features: {
      en: ['75 AI match stars','Unlock 75 job details','Full AI analysis per job','Credits never expire'],
      ar: ['75 نجمة للمطابقة','فتح 75 وظيفة كاملة','تحليل ذكاء اصطناعي لكل وظيفة','الأرصدة لا تنتهي'],
    },
    ctaEN:    'Get 75 Stars — $9.99',
    ctaAR:    'احصل على 75 نجمة — $9.99',
    planId:   'coins_75',
    disabled: false,
  },
  {
